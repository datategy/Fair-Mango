...
Checkout the API documentation for [equal opportunity difference](../api_documentation/metrics.md#fair_mango.metrics.metrics.EqualOpportunityDifference) and for [equal opportunity ration](../api_documentation/metrics.md#fair_mango.metrics.metrics.EqualOpportunityRatio).
