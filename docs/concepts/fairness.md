...
We aknowledge that fairlearn has an amazing [user guide](https://fairlearn.org/v0.10/user_guide/index.html) about fairness in AI. Feel free to check out their work and documentation.
